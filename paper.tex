...
Rather, we focus on methods that explicitly identify introgressed genomic segments based on patterns of nucleotide/haplotype diversity, the extent of differentiation, and phylogenetic relationships.
...
The former is quite similar to the D-statistic but uses allele frequencies from each population/species, and the latter detects introgression based on the localized phylogenetic pattern.
...
The final category to detect introgression include approaches assigning genetic ancestry based on the popular software STRUCTURE \cite{pritchard2000}. 
