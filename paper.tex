...
There is clear evidence of one domestication center in the Fertile Crescent \cite{badr2000origin, Morrell2007}, and many have supported an additional eastern domestication event, potentially from \emph{subsp. spontaneum} east of the Zargos mountains \cite{Morrell2007} or from subsp. \emph{spontaneum} var. \emph{agriocrithon} in modern-day Tibet \cite{dai2012tibet}.
However, recent research \cite{pourkheirandish2018elucidation} suggests that Tibetan \emph{agriocrithon} is not a wild relative, but rather an intercultivar hybrid of domesticated landraces, casting doubt on the Tibetan domestication event from \emph{agriocrithon}.
%However, recent research \cite{pourkheirandish2018elucidation} has suggested that var. \emph{agriocrithon} is a misidentified intercultivar hybrid of domesticated 6-row landraces, which they deem \emph{pseudo-agriocrithon}, as opposed to \emph{eu-agriocrithon}, which are six-rowed wild relatives derived from two-rowed \emph{ssp. spontaneum}.
