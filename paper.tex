...
\gmj{Might need to change the sunflower entry in this table.  The best evidence I can now point to for adaptive introgression is the reintroduction of the branching trait, but that example is not natural.}
...
%\gmj{I am not seeing the reason behind splitting this up in into two paragraphs.  I'll try reformatting the same information below:}
...
However, the dynamics of this process are not yet fully understood in the context of individual cases, and many questions remain.
At what taxonomic scale does introgression occur?
What is the genomic architecture of this introgression, and does the architecture suggest that it has been adaptive?
When do species become so diverged that introgression is either maladaptive or impossible?
To what extent does the level of introgression across taxa depend on divergence time and/or mutation load between donor and recipient taxa? \gmj{I think we could include (effective) population size in this list of factors that determine extent of introgression.}
...
\subsection*{Applied:}
Our identification and understanding of introgression in agroecosystems would be augmented by the development of wild relative genomic resources (annotated genomic sequence assemblies and functional genomic data sets \cite{huang2012}).
