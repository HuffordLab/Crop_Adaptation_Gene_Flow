...
The decreasing cost of genome-wide resequencing and availability of reduced-representation genotyping (\emph{e.g.}, GBS and RAD-Seq), combined with new analytical methods, has facilitated the comprehensive study of introgression across a broad spectrum of domesticated species (\textbf{Table 1}).
...
While the four crop systems described in detail here represent particularly well documented examples of adaptive wild introgression, given their similar histories, many additional crops have likely benefited from beneficial wild-to-crop gene flow during post-domestication expansion (\textbf{Table 1}).
...
Beyond these observations associated with post-domestication adaptation, pervasive wild-to-crop gene flow bears meaningfully on the study of domestication.
...
Mutation rate, effective population size, and strength of selection on introgressed alleles may also influence the rate of breakup of introgressed chromosomal regions.
Detection of introgression will also be affected by the extent of divergence of donor taxa from a crop's wild progenitor; highly divergent introgressed haplotypes will be easier to identify.
