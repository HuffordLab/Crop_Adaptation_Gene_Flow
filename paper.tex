...
For example, based on the sequence divergence, introgression has been detected across \emph{Mimulus} (\emph{i.e.}, monkeyflower) species resulting in adaptation to pollinator preference and contributed to speciation \cite{Stankowski2015};
Jeong et al. \cite{jeong2014} utilized HAPMIX to disclose introgression from Sherpa to Tibetan humans at loci controlling high altitude adaptation (reviewed in \cite{Racimo2015});
ABBA-BABA statistics were employed to reveal introgression of wing coloration loci conferring M\"{u}llerian mimicry
...
across butterfly species \cite{heliconius2012}.
.
...
Barley-\emph{spontaneum} hybrids are fertile and commonly found when these taxa co-occur.
Gene flow between wild and domesticated barley is frequent \cite{dai2012tibet}, at times occurring over distances greater than a kilometer \cite{hillman2001new}.
