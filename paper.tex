...
In such cases, divergence is a mixture of time since domestication and time since split of the progenitor and introgressing species.
This phenomenon, in combination with divergence of samples from true ancestral populations and ongoing evolution of crop progenitors, may explain discrepancies between domestication dates based on genetic and archaeological data. \mbh{perhaps add citations here}
More accurate genetic estimates of the timing of domestication may be obtained by excluding loci that show signatures of introgression.

\subsection*{How was genome-wide diversity impacted by a domestication bottleneck?}
Estimates of the strength of the initial domestication bottleneck may also be skewed when introgression is not considered.
Introgressed chromosomal regions may have a distinct effective population size ($N_e$) relative to non-introgressed regions depending on diversity within the donor taxon.
The influence of introgression on estimates of the domestication bottleneck will depend on a number of factors including the magnitude of introgression, the $N_e$ of the introgressing taxon, and the strength of selection on haplotypes following introgression.
For example, substantial introgression at neutral loci from wild taxa with a historically higher $N_e$ will lead to underestimates of the overall strength of the domestication bottleneck.
