...
We focus here on analytical prospect and limitations and introduce only a few representatives of each category.
...
In addition, RND_{min} is sensitive to variable mutation rate, which reflects on the branch length to the outgroup taxa. 
 ...
 Similarly, $Q95_{A,B,C(w,y)}$ just set a hard cutoff as $95^th$ percentile of allele frequencies in panel B \cite{racimo2016}. 
 These two statistics were also developed into incorporating two source populations (see details in \cite{racimo2016}).
