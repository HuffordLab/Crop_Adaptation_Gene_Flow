...
\cite{gebrekidan1982utilization}\ states that natural introgression of desirable alleles into domesticated sorghum from sympatric weedy populations occurs and has been occuring for "a long time", and that breeding probrams should be developed to accelerate this gene flow.
...
The tomato (\emph{Solanum lycopersicum}, alternatively \emph{Lycopersicon lycopersicum} or \emph{L. esculentum}) center of domestication is not known with certainty.
Various authors have proposed Mexico and/or Peru \cite{robertson2007genetic}, but widescale recent introgression between wild relatives confound attempts at elucidating phylogenies \cite{nesbitt2002comparative}.
...
\cite{rick1958role} summarizes morphological evidence of natural introgressive hybridization with wild relatives (specifically \emph{Solanum pimpinellifolium}) in South America, despite cultivated tomato's proclivity to self-pollinate.
However, these natural introgressions have yet been shown to be adaptive for the plant.
...
\cite{hanson2000mapping} mapped a tomato yellow leaf curl virus resistance gene in an accession of \emph{S. habrochaites} f. \emph{glabratum} \cite{banerjee1990transfer} to an introgression on chromosome 11, which originated through breeding with the wild relative \emph{S. habrochaites}.
Similar resistance traits has also been shown to have been imparted from \emph{S. chilense}, \emph{S. pimpinellifolium}, and \emph{S. cheesmanii} \cite{hanson2000mapping}.
