...
However, these natural introgressions have yet be shown to be adaptive for the plant.
Also, \cite{hanson2000mapping} mapped a tomato yellow leaf curl virus resistance gene in an accession of \emph{S. habrochaites} f. \emph{glabratum} \cite{banerjee1990transfer} to an introgression on chromosome 11, which originated through breeding with the wild relative \emph{S. habrochaites}.
