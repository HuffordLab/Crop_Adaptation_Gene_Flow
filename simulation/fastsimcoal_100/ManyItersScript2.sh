...
mkdir ManyItersResults

for i in {1..100}
do
 echo $i;   
 mkdir ManyItersResults/result.$i;
 cp NPlantsModel_jointMAFpop1_0.obs ManyItersResults/result.$i;
 cp NPlantsModel.est ManyItersResults/result.$i;
 cp NPlantsModel.tpl ManyItersResults/result.$i;
